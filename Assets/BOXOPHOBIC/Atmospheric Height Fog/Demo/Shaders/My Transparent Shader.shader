...
Shader "Custom/My Transparent Shader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 temp_output_81_0_g681 = float3( 0,0,0 );
			float3 temp_output_2_0_g707 = (AHF_FogColor).rgb;
			float3 gammaToLinear3_g707 = GammaToLinearSpace( temp_output_2_0_g707 );
			#ifdef UNITY_COLORSPACE_GAMMA
				float3 staticSwitch1_g707 = temp_output_2_0_g707;
			#else
				float3 staticSwitch1_g707 = gammaToLinear3_g707;
			#endif
			float3 temp_output_34_0_g681 = staticSwitch1_g707;
			float3 temp_output_2_0_g704 = (AHF_DirectionalColor).rgb;
			float3 gammaToLinear3_g704 = GammaToLinearSpace( temp_output_2_0_g704 );
			#ifdef UNITY_COLORSPACE_GAMMA
				float3 staticSwitch1_g704 = temp_output_2_0_g704;
			#else
				float3 staticSwitch1_g704 = gammaToLinear3_g704;
			#endif
			float3 WorldPosition2_g681 = ase_worldPos;
			float3 normalizeResult5_g695 = normalize( ( WorldPosition2_g681 - _WorldSpaceCameraPos ) );
			#if defined(LIGHTMAP_ON) && UNITY_VERSION < 560 //aseld
			float3 ase_worldlightDir = 0;
			#else //aseld
			float3 ase_worldlightDir = Unity_SafeNormalize( UnityWorldSpaceLightDir( ase_worldPos ) );
			#endif //aseld
			float dotResult6_g695 = dot( normalizeResult5_g695 , ase_worldlightDir );
			float temp_output_7_0_g696 = -1.0;
			half DirectionalMask30_g681 = ( ( ( dotResult6_g695 - temp_output_7_0_g696 ) / ( 1.0 - temp_output_7_0_g696 ) ) * AHF_DirectionalIntensity * AHF_DirectionalModeBlend );
			float3 lerpResult40_g681 = lerp( temp_output_34_0_g681 , staticSwitch1_g704 , DirectionalMask30_g681);
			#if defined(AHF_DIRECTIONALMODE_OFF)
				float3 staticSwitch45_g681 = temp_output_34_0_g681;
			#elif defined(AHF_DIRECTIONALMODE_ON)
				float3 staticSwitch45_g681 = lerpResult40_g681;
			#else
				float3 staticSwitch45_g681 = temp_output_34_0_g681;
			#endif
			half3 FogColor65_g681 = staticSwitch45_g681;
			float temp_output_7_0_g700 = AHF_FogDistanceStart;
			half FogDistanceMask12_g681 = saturate( ( ( distance( WorldPosition2_g681 , _WorldSpaceCameraPos ) - temp_output_7_0_g700 ) / ( AHF_FogDistanceEnd - temp_output_7_0_g700 ) ) );
			float temp_output_7_0_g706 = AHF_FogHeightEnd;
			half FogHeightMask16_g681 = saturate( ( ( (WorldPosition2_g681).y - temp_output_7_0_g706 ) / ( AHF_FogHeightStart - temp_output_7_0_g706 ) ) );
			float temp_output_29_0_g681 = ( FogDistanceMask12_g681 * FogHeightMask16_g681 );
			float simplePerlin3D15_g689 = snoise( ( ( WorldPosition2_g681 * ( 1.0 / AHF_NoiseScale ) ) + ( -AHF_NoiseSpeed * _Time.y ) ) );
			float temp_output_7_0_g692 = -1.0;
			float temp_output_7_0_g702 = AHF_NoiseDistanceEnd;
			half NoiseDistanceMask7_g681 = saturate( ( ( distance( WorldPosition2_g681 , _WorldSpaceCameraPos ) - temp_output_7_0_g702 ) / ( 0.0 - temp_output_7_0_g702 ) ) );
			float lerpResult20_g689 = lerp( 1.0 , ( ( simplePerlin3D15_g689 - temp_output_7_0_g692 ) / ( 1.0 - temp_output_7_0_g692 ) ) , ( NoiseDistanceMask7_g681 * AHF_NoiseIntensity * AHF_NoiseModeBlend ));
			half NoiseSimplex3D24_g681 = lerpResult20_g689;
			#if defined(AHF_NOISEMODE_OFF)
				float staticSwitch42_g681 = temp_output_29_0_g681;
			#elif defined(AHF_NOISEMODE_PROCEDURAL3D)
				float staticSwitch42_g681 = ( temp_output_29_0_g681 * NoiseSimplex3D24_g681 );
			#else
				float staticSwitch42_g681 = temp_output_29_0_g681;
			#endif
			half FogAlpha66_g681 = ( staticSwitch42_g681 * AHF_FogIntensity );
			float3 lerpResult82_g681 = lerp( temp_output_81_0_g681 , FogColor65_g681 , FogAlpha66_g681);
			#ifdef AHF_ENABLED
				float3 staticSwitch64_g681 = lerpResult82_g681;
			#else
				float3 staticSwitch64_g681 = temp_output_81_0_g681;
			#endif
			o.Emission = staticSwitch64_g681;
			o.Smoothness = 0.8;
...
/*ASEBEGIN
Version=17101
7;29;1906;1014;2506.071;321.219;3.352071;True;False
...
Node;AmplifyShaderEditor.FunctionNode;78;1408,1056;Inherit;False;Apply Height Fog;-1;;681;950890317d4f36a48a68d150cdab0168;0;1;81;FLOAT3;0,0,0;False;1;FLOAT3;85
...
ASEEND*/
//CHKSM=9B6CB5DE14743DF179A49894CFE43E0E9C096A8E