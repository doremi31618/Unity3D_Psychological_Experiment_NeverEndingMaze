	...
	SubShader {
		...
		Pass {
			...
			half4 frag( v2f i ) : COLOR
			{
				...
				sum.xyz += color10.xyz * 0.070;
				sum.xyz += color09.xyz * 0.078;
				sum.xyz += color08.xyz * 0.078;
				sum.xyz += color07.xyz * 0.086;
				sum.xyz += color06.xyz * 0.086;
				sum.xyz += color05.xyz * 0.096;
				sum.xyz += color04.xyz * 0.096;
				...
				sum.w += color10.w * 0.042;
				sum.w += color09.w * 0.056;
				sum.w += color08.w * 0.056;
				sum.w += color07.w * 0.075;
				sum.w += color06.w * 0.075;
				sum.w += color05.w * 0.102;
				sum.w += color04.w * 0.102;
